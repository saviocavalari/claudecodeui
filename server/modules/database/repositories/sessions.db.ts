...
const SESSION_ROW_COLUMNS =
  'session_id, provider, provider_session_id, project_path, jsonl_path, custom_name, pending_context, model, effort, isArchived, created_at, updated_at, created_by_user_id, created_by_username';
...
export const sessionsDb = {
  ...
  createAppSession(
    ...
    ).run(sessionId, provider, customName ?? null, normalizedProjectPath, createdByUserId, createdByUsername);
